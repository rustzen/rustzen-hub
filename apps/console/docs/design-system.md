# Rustzen Design System — Platform Dashboard

> Brand & UI spec for the **apps/console** admin dashboard (Next.js + Tailwind v4 + shadcn/ui).
> The **token system is shared** with the marketing site and the product GUI — see
> [`rustzen/rustzen-hub apps/site` design-system.md §1](../../site/docs/design-system.md) for the
...
[`apps/site/docs/design-system.md` §1](../../site/docs/design-system.md). Copy that block
...
- **Sidebar** — zen-navy glass (`backdrop-blur`, brand-200 hairline borders), brand
  mark + "Rustzen Platform / Control plane". Active item: brand-400 left marker (4px)
...
`.dark` swaps paper/panel/surface to the navy ramp (apps/site §1.6). The sidebar is
